\chapter{State of the Art Manipulation Planning}
\todo[inline]{cite David's works}
...
\paragraph{Learning in Task Planning}
...
\todo[inline]{Check fro backtracking techniques in planning, way to evaluate a plan}
...
\todo[inline]{Review of pushing techniques}
